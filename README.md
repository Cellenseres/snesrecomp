...
| Nintendo DSP-1 / DSP-1B | **Implemented; SMK validation pending** | Instruction-level NEC uPD7725 core and Super Mario Kart-compatible DSP-1 board windows are implemented. Requires a user-supplied `dsp1b.rom`, `dsp1.rom`, or word-reversed `dsp1.bin`; no firmware is redistributed. |
